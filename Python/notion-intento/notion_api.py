...
databaseID ="" # ID de la base de datos que se quiere leer
pageID='21284938fa4646429d2bb645f2fa18a0' #Page ID de la pagina principal donde esta mario programando
...
def responseDatabase(pageID,headers):
    ...
    print(res.text)
responseDatabase(pageID, headers)